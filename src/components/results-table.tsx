...
export default function ResultsTable({ results, visibleCols }: ResultsTableProps) {
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 px-5 py-4 border-b border-gray-200 bg-gray-50">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="rounded-lg border border-gray-300 px-3 py-1.5 text-[12px] w-48"
          />
          <button
            onClick={exportXlsx}
      ...
      <div className="overflow-auto max-h-[560px]">
        <table className="w-full text-[12px]">
          ...
          <tbody>
            ...
            {shown.length === 0 ? (
              <tr>
                <td colSpan={4 + visibleCols.length} className="px-3 py-6 text-center text-gray-400">
